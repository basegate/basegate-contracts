...
```solidity
function countInitializedTicksCrossed(contract IBaseGatePool self, int24 tickBefore, int24 tickAfter) internal view returns (uint32 initializedTicksCrossed)
```
