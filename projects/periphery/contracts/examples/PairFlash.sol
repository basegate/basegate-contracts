...
import '@basegate_io/core/contracts/interfaces/callback/IBaseGateFlashCallback.sol';
...
/// @notice An example contract using the BaseGate V3 flash function
contract PairFlash is IBaseGateFlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `BaseGateFlashCallback`
    function initFlash(FlashParams memory params) external {
        ...
        IBaseGatePool pool = IBaseGatePool(PoolAddress.computeAddress(deployer, poolKey));
