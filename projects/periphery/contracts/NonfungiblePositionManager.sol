...
import '@basegate_io/core/contracts/libraries/FixedPoint128.sol';
...
/// @title NFT positions
/// @notice Wraps BaseGate positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the BaseGate position
    struct Position {
    ...
    constructor(
        ...
        ERC721Permit('BaseGate Positions NFT-V1', 'PCS-V3-POS', '1')
