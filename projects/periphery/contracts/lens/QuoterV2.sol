...
import '@basegate_io/core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IBaseGateSwapCallback, PeripheryImmutableState {
    ...
    function getPool(address tokenA, address tokenB, uint24 fee) private view returns (IBaseGatePool) {
        return IBaseGatePool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function baseGateSwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory path) external view override {
        ...
        IBaseGatePool pool = getPool(tokenIn, tokenOut, fee);
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IBaseGatePool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
