...
import './BaseGatePool.sol';

contract BaseGatePoolDeployer is IBaseGatePoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc IBaseGatePoolDeployer
    ...
    /// @param factory The contract address of the BaseGate factory
    ...
    function deploy(
        ...
        pool = address(new BaseGatePool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
