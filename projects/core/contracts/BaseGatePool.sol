...
import './interfaces/IBaseGateFactory.sol';
...
contract BaseGatePool is IBaseGatePool {
    ...
    /// @inheritdoc IBaseGatePoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == IBaseGateFactory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IBaseGatePoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IBaseGatePoolDerivedState
    ...
    /// @inheritdoc IBaseGatePoolActions
    ...
    function mint(
        ...
        IBaseGateMintCallback(msg.sender).baseGateMintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IBaseGateSwapCallback(msg.sender).baseGateSwapCallback(amount0, amount1, data);
    ...
    function flash(address recipient, uint256 amount0, uint256 amount1, bytes calldata data) external override lock {
        ...
        IBaseGateFlashCallback(msg.sender).baseGateFlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IBaseGatePoolOwnerActions
