...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IBaseGateSwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    function baseGateSwapCallback(int256 amount0Delta, int256 amount1Delta, bytes memory path) external view override {
        ...
        IBaseGatePool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        returns (uint256 amountOut, uint160 sqrtPriceX96After, uint32 initializedTicksCrossed, uint256 gasEstimate)
    {
        ...
        IBaseGatePool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
